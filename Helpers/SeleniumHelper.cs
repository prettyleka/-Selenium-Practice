...

{
...

    {
...

        {
            ...
            return DriverManager.DriverManager.Driver.WindowHandles;
...

        {
...

            {
                ...
                DriverManager.DriverManager.Driver.SwitchTo().Alert().Accept();
...

            {
...

                {
...

                    {
                        ...
                        DriverManager.DriverManager.Driver.SwitchTo().Window(window);
...

        {
...

            {
                ...
                oObj = (DriverManager.DriverManager.Driver as IJavaScriptExecutor).ExecuteScript(command);
...

        {
            ...
            DriverManager.DriverManager.Driver.Navigate().Back();
...

        {
            ...
            DriverManager.DriverManager.Driver.SwitchTo().Window(DriverManager.DriverManager.Driver.WindowHandles[0]);
...

        {
...

            {
...

                {
                    ...
                    DriverManager.DriverManager.Driver.SwitchTo().Frame(element);
        ...
        public static IWebElement FindElement(By by, int timeoutInSeconds = 10, bool displayed = false)

        {

            IWebElement element = null;

            var wait = new WebDriverWait(DriverManager.DriverManager.Driver, TimeSpan.FromSeconds(timeoutInSeconds));
        ...
        public static string GetTextFromElement(IWebElement elemet, int timeOutInSeconds = 5)
        ...
        public static string GetTextFromElement(By by, int timeOutInSeconds = 5)
        ...
        public static string GetTextFromElement(IWebElement elemet, By by, int timeOutInSeconds = 5)
        ...
        public static Status ElementIsExists(By by, int timeOutInSeconds = 5)
        ...
        public static Status OnClick(By by, int timeoutInSeconds = 10)
        ...
        public static Status OnClick(IWebElement element, By by, int timeoutInSeconds = 10)
...

        {
            ...
            DriverManager.DriverManager.Driver.SwitchTo().DefaultContent();

            if (element != null)

            {

                IJavaScriptExecutor js = (IJavaScriptExecutor)DriverManager.DriverManager.Driver;
...

        {
            ...
            ((IJavaScriptExecutor)DriverManager.DriverManager.Driver).ExecuteScript("window.scrollBy(0,0);");
...

        {
...

            {
                ...
                isScrollContainerExist = bool.Parse((string)((IJavaScriptExecutor)DriverManager.DriverManager.Driver).ExecuteScript(@"return document.getElementById('scrollContainer') != null? ""true"":""false"";"));
...

            {
...

                {
                    ...
                    Screenshot ss = ((ITakesScreenshot)DriverManager.DriverManager.Driver).GetScreenshot();
...

        {
            ...
            return DriverManager.DriverManager.Driver.Navigate();
...

        {
            ...
            return DriverManager.DriverManager.Driver.Url;
...

        {
            ...
            if (DriverManager.DriverManager.Driver != null)

                DriverManager.DriverManager.Driver.Close();
...

        {
            ...
            ((IJavaScriptExecutor)DriverManager.DriverManager.Driver).ExecuteScript(@"document.onreadystatechange = function () {if (document.readyState == ""interactive"") {initApplication();  }}");
...

        {
...

            {
                ...
                if (DriverManager.DriverManager.Driver != null)
                    ...
                    DriverManager.DriverManager.Driver.Quit();

                DriverManager.DriverManager.Driver = null;
...

        {
...

            {
                ...
                WebDriverWait wait = new WebDriverWait(DriverManager.DriverManager.Driver, TimeSpan.FromSeconds(timeOutInSeconds));
...

        {
...

            {
                ...
                ((IJavaScriptExecutor)DriverManager.DriverManager.Driver)
